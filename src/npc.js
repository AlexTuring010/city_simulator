 ...
 * - GRID.tileToWorld(x,y)
 * - GRID.isBlocked(x,y)
 * - GRID.tileH (for yOffset)
 *
 * Also uses findPath() and scribble helpers for path indicator.
 */
...
export class NPC {
  ...
  drawPathIndicator(nextWorld) {
    ...
    // 2) Trim cached polyline so start follows NPC without changing curve
